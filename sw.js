...
const CACHE_APP = 'caixa-gv-app-v7';
const CACHE_STATIC = 'caixa-gv-static-v7';
...
// Permite que a página peça ao SW em espera para assumir o controle imediatamente
// (usado pelo botão "Atualizar" quando uma nova versão é detectada).
